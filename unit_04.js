...
function f2() {
let in_button = document.querySelector('.b-2').value;
alert (in_button);
}
...
function f4() {
let cb_4 = document.querySelector('.i-4');
// let b4 = document.querySelector('.b-4').innerText;
...
function f5() {
    let cb_5 = document.querySelector('.i-5');
    let out5 = document.querySelector('.out-5');
    if (cb_5.checked) {
        out5.innerHTML = cb_5.value;
    }else{
